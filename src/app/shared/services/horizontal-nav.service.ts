...
export class HorizontalNavService {
  ...
  MENUITEMS: HorizontalMenu[] = [
    ...
    {
      title: 'Forms', icon: 'edit', type: 'sub', badgeValue: '6', active: false,
      children: [
    ...
    {
      title: 'Advanced UI', icon: 'copy', type: 'sub',  badgeValue: '6', active: false,
      children: [
        {
        ...
        {
        title: 'Charts', icon: 'pie-chart', type: 'sub', badgeValue: '5', active: false,
        children: [
      ...
      {
        title: 'E-Commerce', icon: 'shopping-cart', type: 'sub', badgeValue: '3', active: false,
        children: [
    ...
    {
      title: 'Icons', icon: 'droplet', type: 'sub', badgeValue: '11', active: false,
      children: [
