...
import { Home, Layers, Box, 	Edit, PieChart, Zap, Map, Grid, Droplet, ShoppingCart, Layout, Users, HelpCircle, File, Cpu, Sliders,Truck } from 'angular-feather/icons';
...
const icons = {
  Home, Layers, Box, 	Edit, PieChart, Map, Grid, Zap, Droplet, ShoppingCart, Layout, Users, HelpCircle, File, Cpu, Sliders,Truck
};
