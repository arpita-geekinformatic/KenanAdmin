...
@Component({
  selector: 'app-add-browseinspection',
  templateUrl: './add-browseinspection.component.html',
  styleUrls: ['./add-browseinspection.component.scss']
})
export class AddBrowseinspectionComponent implements OnInit {
