...
import { CrudService } from 'src/app/shared/services/crud.service';  // CRUD API service class
...
export class MemberListComponent implements OnInit {
  ...
  deletemember(member:any) {
    if (window.confirm('Are sure you want to delete this member ?')) { // Asking from user before Deleting member data.
      ...
      this.toastr.success(member.firstName + ' successfully deleted!'); // Alert message will show up when member successfully deleted.
    }
  }
