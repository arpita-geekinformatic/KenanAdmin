...
import { CrudService } from 'src/app/shared/services/crud.service';  // CRUD services API
...
export class AddMemberComponent implements OnInit {
  ...
  submitMemberData() {
    ...
    this.toastr.success(this.memberForm.controls['designation'].value + ' successfully added!'); // Show success message when data is successfully submited
